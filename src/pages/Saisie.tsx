  ...
  const onSave = (dossierPatch: Partial<Dossier>, clientPatch: Partial<Client>) => {
    ...
    if (selectedClient) {
      ...
      const patch: Partial<Client> = {
        ...
        lieuNaissance: clientPatch.lieuNaissance ?? selectedClient.lieuNaissance,
        adresse: clientPatch.adresse ?? selectedClient.adresse,
        codePostal: clientPatch.codePostal ?? selectedClient.codePostal,
        ...
        conjointPrenom: clientPatch.conjointPrenom ?? selectedClient.conjointPrenom,
        conjointNom: clientPatch.conjointNom ?? selectedClient.conjointNom,
        conjointNaissance: clientPatch.conjointNaissance ?? selectedClient.conjointNaissance,
        conjointLieuNaissance: clientPatch.conjointLieuNaissance ?? selectedClient.conjointLieuNaissance,
        conjointTel: clientPatch.conjointTel ?? selectedClient.conjointTel,
        conjointEmail: clientPatch.conjointEmail ?? selectedClient.conjointEmail,
        conjointProfession: clientPatch.conjointProfession ?? selectedClient.conjointProfession,
      ...
      const newClient = addClient({
        ...
        lieuNaissance: clientPatch.lieuNaissance,
        adresse: clientPatch.adresse,
        codePostal: clientPatch.codePostal,
        ville: clientPatch.ville ?? '',
        profession: clientPatch.profession ?? '',
        conjoint: clientPatch.conjoint,
        conjointPrenom: clientPatch.conjointPrenom,
        conjointNom: clientPatch.conjointNom,
        conjointNaissance: clientPatch.conjointNaissance,
        conjointLieuNaissance: clientPatch.conjointLieuNaissance,
        conjointTel: clientPatch.conjointTel,
        conjointEmail: clientPatch.conjointEmail,
        conjointProfession: clientPatch.conjointProfession,
